...
const char* LanguageManager::Tr(const char* englishText) {
    ...
    static const std::unordered_map<std::string, std::string> dictionary = {
        ...
        {"Loop Emission", "ループ発生"},
        {"Burst Count", "バースト数"},
        {"Trigger Burst", "バースト発生 (単発)"},
        {"Align to Velocity", "進行方向を向く"},
        {"Base Color", "基本カラー"},
        {"Scale Over Lifetime", "スケールの時間変化"},
        {"Enable Scale Over Lifetime", "スケール時間変化を有効化"},
        {"Curve Type", "カーブ形式"},
        {"Start Scale", "開始スケール"},
        {"End Scale", "終了スケール"},
        {"Peak Scale", "ピークスケール"},
        {"Color Over Lifetime", "カラーの時間変化"},
        {"Enable Color Over Lifetime", "カラー時間変化を有効化"},
        {"Start Color", "開始カラー"},
        {"End Color", "終了カラー"},
        {"Radial Speed", "放射速度"},
        {"Radial Speed Variance", "放射速度のばらつき"},
        {"Cube Size", "キューブサイズ"},
